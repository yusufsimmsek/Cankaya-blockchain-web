    ...
    <section id="projects" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-neutral-900 dark:text-neutral-100 mb-6 text-gradient-primary">{t('projects_title')}</h2>
          <p className="text-lg sm:text-xl text-neutral-700 dark:text-neutral-300 max-w-4xl mx-auto leading-relaxed">{t('projects_p')}</p>
        </div>
              ...
              <div className={`relative bg-white/40 dark:bg-neutral-800/30 backdrop-blur-xl border border-white/20 dark:border-neutral-500/20 rounded-3xl overflow-hidden group-hover:shadow-2xl transition-all duration-700 hover:scale-[1.02] hover:-translate-y-1 group ${
                ...
                <div className="p-8 relative z-10">
                  ...
                  <a
                    ...
                    <span className="mr-2">{t('view_details')}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="text-center animate-fade-in-up">
            ...
            <p className="text-neutral-600 dark:text-neutral-400 font-semibold">{t('awards_count')}</p>
          </div>
          <div className="text-center animate-fade-in-up" style={{ animationDelay: '100ms' }}>
            ...
            <p className="text-neutral-600 dark:text-neutral-400 font-semibold">{t('total_prize')}</p>
          </div>
          <div className="text-center animate-fade-in-up" style={{ animationDelay: '200ms' }}>
            ...
            <p className="text-neutral-600 dark:text-neutral-400 font-semibold">{t('hackathon')}</p>
          </div>
        </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white/50 dark:bg-neutral-800/40 backdrop-blur-xl p-8 md:p-12 rounded-3xl border border-white/20 dark:border-neutral-600/20 shadow-xl hover:shadow-2xl transition-all duration-700 hover:scale-[1.01] overflow-hidden">
              ...
              <div className="flex items-center justify-center mb-6">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold text-neutral-900 dark:text-neutral-100 mb-4">{t('more_projects')}</h3>
                <p className="text-lg text-neutral-600 dark:text-neutral-400 mb-8 max-w-2xl mx-auto leading-relaxed">{t('more_projects_p')}</p>
              <a
                ...
                >
                  ...
                  <span className="relative z-10">{t('view_on_github')}</span>
