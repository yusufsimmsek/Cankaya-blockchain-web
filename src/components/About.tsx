import { Globe, Rocket, Shield, Heart, Cpu, Eye, TrendingUp, GraduationCap, Share2, FileText, Target, Calendar, Users } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black text-neutral-900 dark:text-neutral-100 mb-8 leading-tight relative py-4">
            <span className="text-gradient-primary">{t('about_heading_1')}</span>
            <span className="text-gradient-secondary">{t('about_heading_2')}</span>
            {/* 3D Shadow Effect */}
        ...
        <div className="mb-24">
          <div className="text-center mb-16 animate-fade-in-up">
            <h3 className="text-3xl sm:text-4xl font-black text-neutral-900 dark:text-neutral-100 mb-6"><span className="text-gradient-primary">{t('skills')}</span></h3>
            <p className="text-xl text-neutral-600 dark:text-neutral-400 max-w-3xl mx-auto leading-relaxed">{t('skills_p')}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-8">
            {techStack.map((tech, index) => (
              ...
              >
                ...
                <div className="relative bg-white/70 dark:bg-neutral-900/70 backdrop-blur-xl p-8 rounded-3xl border border-neutral-200/50 dark:border-neutral-800/50 shadow-lg hover:shadow-2xl transition-all duration-500 group-hover:scale-105 overflow-hidden h-full flex flex-col">
                  {/* Holographic Shimmer */}
                  ...
                  <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed group-hover:text-neutral-700 dark:group-hover:text-neutral-300 transition-colors duration-300 relative z-10 font-mono text-sm flex-grow">
                    {tech.description}
                  </p>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div className="group relative animate-fade-in-up perspective-1000">
            ...
            {/* 3D Mission Card */}
            <div className="relative bg-white/70 dark:bg-neutral-900/70 backdrop-blur-xl p-10 rounded-3xl border border-blue-200/50 dark:border-blue-800/50 shadow-lg hover:shadow-2xl transition-all duration-500 group-hover:scale-105 group-hover:rotate-y-3 overflow-hidden h-full flex flex-col">
              {/* Holographic Shimmer */}
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/15 to-transparent -skew-x-12 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
              ...
              <div className="flex items-center mb-8 relative z-10">
                ...
                <h3 className="text-2xl font-black text-neutral-900 dark:text-neutral-100 group-hover:text-gradient-primary transition-all duration-300">{t('mission')}</h3>
              </div>
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed text-lg group-hover:text-neutral-800 dark:group-hover:text-neutral-200 transition-colors duration-300 relative z-10 flex-grow">{t('mission_p')}</p>
            </div>
          </div>
          ...
          <div className="group relative animate-fade-in-up perspective-1000">
            ...
            {/* 3D Vision Card */}
            <div className="relative bg-white/70 dark:bg-neutral-900/70 backdrop-blur-xl p-10 rounded-3xl border border-purple-200/50 dark:border-purple-800/50 shadow-lg hover:shadow-2xl transition-all duration-500 group-hover:scale-105 group-hover:rotate-y-3 overflow-hidden h-full flex flex-col">
              {/* Holographic Shimmer */}
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/15 to-transparent -skew-x-12 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
              ...
              <div className="flex items-center mb-8 relative z-10">
                ...
                <h3 className="text-2xl font-black text-neutral-900 dark:text-neutral-100 group-hover:text-gradient-primary transition-all duration-300">{t('vision')}</h3>
              </div>
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed text-lg group-hover:text-neutral-800 dark:group-hover:text-neutral-200 transition-colors duration-300 relative z-10 flex-grow">{t('vision_p')}</p>
            </div>
          </div>
        </div>
      </div>
