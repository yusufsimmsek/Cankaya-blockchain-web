...
const Footer = () => {
  ...
  const achievements = [
    { icon: Calendar, value: '100+', label: t('footer_stats_events'), color: 'from-primary-500 to-secondary-500' },
    { icon: Users, value: '1000+', label: t('footer_stats_members'), color: 'from-secondary-500 to-primary-500' },
    { icon: Award, value: '10+', label: t('footer_stats_awards'), color: 'from-primary-500 to-secondary-500' },
    { icon: Rocket, value: '15+', label: t('footer_stats_projects'), color: 'from-secondary-500 to-primary-500' }
  ]
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-2 animate-fade-in-up">
              <div className="flex items-start mb-8 group">
                ...
                <div className="ml-6 flex-1">
                  ...
                  <p className="text-neutral-300 mb-6 max-w-lg leading-relaxed dark:text-neutral-400 text-sm">{t('footer_brand_p')}</p>
          ...
          <div className="border-t border-neutral-700/50 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <div className="text-neutral-400 text-sm">{t('copyright')}</div>
