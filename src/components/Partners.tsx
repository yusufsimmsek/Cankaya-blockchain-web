...
const Partners = () => {
  ...
  const stats = [
    { icon: Zap, value: "12+", label: t('partners_stat_exchanges'), color: "from-blue-500 to-cyan-500" },
    { icon: Target, value: "10+", label: t('partners_stat_ecosystem'), color: "from-purple-500 to-pink-500" },
    { icon: Award, value: "10+", label: t('partners_stat_community'), color: "from-green-500 to-blue-500" },
    { icon: Globe, value: "10+", label: t('partners_stat_education'), color: "from-orange-500 to-red-500" }
  ]
    ...
    <section id="partners" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-neutral-900 dark:text-neutral-100 mb-6 text-gradient-primary">{t('partners_title')}</h2>
          <p className="text-lg sm:text-xl text-neutral-700 dark:text-neutral-300 max-w-4xl mx-auto leading-relaxed">{t('partners_p')}</p>
        </div>
