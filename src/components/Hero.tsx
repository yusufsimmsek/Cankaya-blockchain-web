          ...
          <div className="w-full flex justify-center">
            ...
            <div className="card-hover p-6 text-center group bg-white/10 backdrop-blur-sm border border-white/20 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="text-sm text-white font-medium group-hover:scale-105 transition-transform duration-500">{t('hero_stat_foundation')}</div>
              </div>
            </div>
            <div className="card-hover p-6 text-center group bg-white/10 backdrop-blur-sm border border-white/20 relative overflow-hidden">
              {/* Animated Gradient Background */}
              ...
              <div className="relative z-10">
                ...
                <div className="text-sm text-white font-medium group-hover:scale-105 transition-transform duration-500">{t('hero_stat_projects')}</div>
              </div>
            </div>
            <div className="card-hover p-6 text-center group bg-white/10 backdrop-blur-sm border border-white/20 relative overflow-hidden">
              {/* Animated Gradient Background */}
              ...
              <div className="relative z-10">
                ...
                <div className="text-sm text-white font-medium group-hover:scale-105 transition-transform duration-500">{t('hero_stat_events')}</div>
              </div>
              </div>
            </div>
          </div>
