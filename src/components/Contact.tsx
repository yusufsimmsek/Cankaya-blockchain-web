    ...
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-neutral-900 dark:text-neutral-100 mb-6 text-gradient-primary">{t('contact_title')}</h2>
          <p className="text-lg sm:text-xl text-neutral-700 dark:text-neutral-300 max-w-3xl mx-auto leading-relaxed">{t('contact_p')}</p>
        </div>
            ...
            {/* Address Card */}
              ...
              <div className="relative flex items-center gap-6 p-8 rounded-2xl border border-neutral-200/50 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                ...
                <div className="flex flex-col justify-center">
                  <h4 className="text-lg font-semibold text-neutral-900 mb-2 dark:text-neutral-100">{t('address')}</h4>
                  <p className="text-neutral-600 dark:text-neutral-200 text-base">{t('ankara_turkey')}</p>
                    </div>
                  </div>
                </div>
            ...
            >
              ...
              <div className="relative flex items-center gap-6 p-8 rounded-2xl border border-neutral-200/50 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105 h-full">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p className="text-neutral-600 dark:text-neutral-200 text-base">info@cankayablockchain.com</p>
