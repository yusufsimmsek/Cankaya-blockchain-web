...
const translations: Translations = {
  ...
  copyright: { tr: '© 2026 Çankaya Blockchain Topluluğu. Tüm hakları saklıdır.', en: '© 2026 Cankaya Blockchain Community & Labs. All rights reserved.' },
  ...
  footer_cta_title: { tr: 'Kulübe Katıl', en: 'Join the Club' },
  footer_cta_description: { tr: 'Blockchain yolculuğunuza bizimle başlayın ve teknolojinin geleceğinin bir parçası olun.', en: 'Start your blockchain journey with us and be part of the future of technology.' },
  footer_email_placeholder: { tr: 'E-posta adresinizi girin', en: 'Enter your email address' },
  footer_cta_button: { tr: 'Yolculuğunuza Başlayın', en: 'Start Your Journey' },
}
