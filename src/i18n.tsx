...
const translations: Translations = {
  ...
  events_subtitle: { tr: "Çankaya Blockchain Topluluğu olarak 2021'den beri düzenlediğimiz etkinlikler ve katıldığımız zirvelerle blockchain ekosisteminde aktif rol oynuyoruz.", en: 'As Cankaya Blockchain Community, since 2021, we have actively taken part in the blockchain ecosystem with events and summits.' },
  ...
  partners_p: { tr: 'Çankaya Blockchain Topluluğu olarak blockchain ekosisteminin önde gelen kuruluşları ve topluluklarıyla stratejik ortaklıklar kurarak büyümeye devam ediyoruz.', en: 'As Cankaya Blockchain Community, we continue to grow by forming strategic partnerships with leading organizations and communities in the blockchain ecosystem.' },
  ...
  contact_cta_p: { tr: 'Çankaya Blockchain Topluluğu ile blockchain ekosisteminde birlikte değer yaratmak ve geleceği şekillendirmek için iletişime geçin.', en: 'Get in touch with Cankaya Blockchain Community to create value together and shape the future in the blockchain ecosystem.' },
  contact_cta_btn: { tr: 'İletişime Geç', en: 'Contact Us' },
  projects_title: { tr: 'Ödüllü Projelerimiz', en: 'Our Award-Winning Projects' },
  projects_p: { tr: "Çankaya Blockchain Topluluğu olarak hackathon'larda ödül kazanan ve ekosisteme değer katan projelerimizle blockchain teknolojilerinin gerçek hayat uygulamalarını geliştiriyoruz.", en: 'As Cankaya Blockchain Community, with award-winning projects, we develop real-life applications of blockchain technologies.' },
  ...
  footer_brand_p: { tr: "Çankaya Blockchain Topluluğu - 2021'den beri Ankara'da blockchain teknolojilerini öğreten, projeler geliştiren ve ekosisteme nitelikli bireyler kazandıran öncü topluluk.", en: 'Cankaya Blockchain Community - Since 2021 in Ankara, we teach blockchain, build projects, and contribute skilled people to the ecosystem.' },
  quick_links: { tr: 'Hızlı Linkler', en: 'Quick Links' },
  footer_contact: { tr: 'İletişim', en: 'Contact' },
  copyright: { tr: '© 2025 Çankaya Blockchain Topluluğu. Tüm hakları saklıdır.', en: '© 2025 Cankaya Blockchain Community. All rights reserved.' },
